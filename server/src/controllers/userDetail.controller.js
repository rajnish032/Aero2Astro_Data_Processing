...
export const getGisById = expressAsyncHandler(async (req, res) => {
  try {
  ...
  <div class="email-container">
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>
               Thank you for applying for the Gis Data Processing partnership with us! Your application is now under review, and we will get back to you soon, you will recieve call or status updates through emails. So stay Tuned!
            </p>
...
export const addLicense = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const { licenseNumber, classUas, gisName, licenseName, dateOfIssuance } =
      req.body;

    if (
      !(licenseNumber && classUas && licenseName && gisName && dateOfIssuance)
    ) {
      return res.status(400).json({ message: "All Fields are required" });
    }
