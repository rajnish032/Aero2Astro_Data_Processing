...
router.put("/user/approve/:id",verifyAdminAuth,handleGisApproval);
router.put("/user/reject/:id",verifyAdminAuth,handleGisRejection);
router.put("/user/enableEdit/:id",verifyAdminAuth,handleEnablingEdit);
router.put("/user/suspend/:id",verifyAdminAuth,handleGisSuspension);
